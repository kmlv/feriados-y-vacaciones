...
![Nivel y composición del descanso garantizado por la ley en Perú, corte 2026. El total es un valor esperado bajo el supuesto de colocación uniforme, no un mínimo exigible; la sección «Por qué el total no es la suma» lo desarrolla. *Fuente:* elaboración propia; las cifras son las mismas que alimentan los cuadros de este documento.](figuras/figura-apertura-es.png)

- **Nivel.** Un trabajador de referencia en Perú tiene garantizados
  32,4 días de trabajo liberados y pagados al año, equivalentes al
  12,5 % de su año laboral. La mediana de Iberoamérica es
...
![Días de trabajo liberados y pagados al año contra producto por habitante en paridad de poder adquisitivo, escala logarítmica.](figuras/figura-dispersion-ppp-es.png)
