...
La unidad de referencia no es el país: es **Bangkok**, la jurisdicción concreta donde vive el trabajador de referencia. En un país sin ley nacional única de feriados, «el número del país» no existe, y promediar jurisdicciones fabricaría una cifra que ninguna norma concede.
...
1. **Doce (12) días tradicionales restantes de la cuota de trece — fechas designadas por el empleador**: la ley fija la cantidad y deja las fechas a designación del empleador dentro de un conjunto de referencia. Se registra la cantidad y el conjunto, sin fechas.
