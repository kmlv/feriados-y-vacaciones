...
# Semana laboral supuesta cuando la norma no la declara. Se declara aquí y la
# salida dice cuántas unidades dependen de ella.
BASE_POR_DEFECTO = 5
...
def _calcular(con, corte: int, marco: str = "real",
    ...
    for iso in sorted(unidades):
        ...
        sem = (dias / 7 if tipo == "calendario" else dias if tipo == "semanas"
               else dias / (base_norm or BASE_POR_DEFECTO))
