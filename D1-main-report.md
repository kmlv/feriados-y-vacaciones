...
![Level and composition of statutory rest in Peru, 2026 cut. The total is an expected value under the uniform-placement assumption, not an enforceable minimum; the section «Why the total is not the sum» develops this. *Source:* authors' calculations; the figures are the same ones that feed the exhibits in this document.](figuras/figura-apertura-en.png)

- **Level.** A reference worker in Peru is guaranteed 32.4 paid
  work days released per year, equivalent to 12.5 % of their working
  year. The Ibero-American median is 22.8 days and the OECD median
  28.5.
...
![Paid work days released per year against output per head at purchasing power parity, logarithmic scale.](figuras/figura-dispersion-ppp-en.png)
...
| Generator hash | `71eb599cb03da0a1…` |
